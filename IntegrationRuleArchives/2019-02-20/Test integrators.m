...
(* ::Title:: *)
(*Test Rubi and Mathematica integrators*)
...
ProblemsDirectory = NotebookDirectory[];
...
If[Integrator==="Rubi",
(*Get[FileNameJoin[{NotebookDirectory[],"Rubi.m"}]]]; *)
  Get["C:\\Users\\Albert D. Rich\\AppData\\Roaming\\Mathematica\\Paclets\\Repository\\Rubi-4.16.0.2\\Rubi.m"]];
ShowSteps = False;


Clear[Unintegrable];
Clear[CannotIntegrate];


Get[NotebookDirectory[]<>"Integration test routines.m"];
...
IntegrationTest["3 Logarithms\\3.1 u (a+b log(c x^n))^p"];


IntegrationTest["3 Logarithms\\3.2 u (a+b log(c (d+e x)^n))^p"];


IntegrationTest["3 Logarithms\\3.3 u (a+b log(c (d+e x^m)^n))^p"];


IntegrationTest["3 Logarithms\\3.4 u log(e (f (a+b x)^p (c+d x)^q)^r)^s"];
...
IntegrationTest["5 Inverse trig functions\\5.1 Inverse sine\\5.1.4a (f x)^m (d-c^2 d x^2)^p (a+b arcsin(c x))^n"];


IntegrationTest["5 Inverse trig functions\\5.1 Inverse sine\\5.1.4b (f x)^m (d+e x^2)^p (a+b arcsin(c x))^n"];
...
IntegrationTest["5 Inverse trig functions\\5.3 Inverse tangent\\5.3.1 u (a+b arctan(c x))^p"];


IntegrationTest["5 Inverse trig functions\\5.3 Inverse tangent\\5.3.2 u (a+b arctan(c x^n))^p"];


IntegrationTest["5 Inverse trig functions\\5.3 Inverse tangent\\5.3.3 u (a+b arctan(c+d x))^p"];


IntegrationTest["5 Inverse trig functions\\5.3 Inverse tangent\\5.3.4 Exponentials of inverse tangent"];


IntegrationTest["5 Inverse trig functions\\5.3 Inverse tangent\\5.3.5 Inverse tangent functions"];
...
IntegrationTest["7 Inverse hyperbolic functions\\7.1 Inverse hyperbolic sine\\7.1.4a (f x)^m (d+c^2 d x^2)^p (a+b arcsinh(c x))^n"];


IntegrationTest["7 Inverse hyperbolic functions\\7.1 Inverse hyperbolic sine\\7.1.4b (f x)^m (d+e x^2)^p (a+b arcsinh(c x))^n"];
...
IntegrationTest["7 Inverse hyperbolic functions\\7.2 Inverse hyperbolic cosine\\7.2.4a (f x)^m (d-c^2 d x^2)^p (a+b arccosh(c x))^n"];


IntegrationTest["7 Inverse hyperbolic functions\\7.2 Inverse hyperbolic cosine\\7.2.4b (f x)^m (d+e x^2)^p (a+b arccosh(c x))^n"];
...
IntegrationTest["7 Inverse hyperbolic functions\\7.3 Inverse hyperbolic tangent\\7.3.1 u (a+b arctanh(c x))^p"];


IntegrationTest["7 Inverse hyperbolic functions\\7.3 Inverse hyperbolic tangent\\7.3.2 u (a+b arctanh(c x^n))^p"];


IntegrationTest["7 Inverse hyperbolic functions\\7.3 Inverse hyperbolic tangent\\7.3.3 u (a+b arctanh(c+d x))^p"];


IntegrationTest["7 Inverse hyperbolic functions\\7.3 Inverse hyperbolic tangent\\7.3.4 Exponentials of inverse hyperbolic tangent functions"];


IntegrationTest["7 Inverse hyperbolic functions\\7.3 Inverse hyperbolic tangent\\7.3.5 Inverse hyperbolic tangent functions"];
