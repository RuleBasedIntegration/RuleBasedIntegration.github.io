...
NiceSqrtQ::usage = "If u has a nice squareroot (e.g. a rational number or an expression raised to an even power), NiceSqrtQ[u] returns True, else it returns False.";
NiceSqrtQ[u_] :=
...
PerfectSquareQ::usage = "If u is a rational number whose squareroot is rational or if u is of the form u1^n1 u2^n2 ... and n1, n2, ... are even, PerfectSquareQ[u] returns True; else it returns False.";
PerfectSquareQ[u_] :=
  If[RationalQ[u],
...
(* LinearProductQ::usage = "LinearProductQ[u,x] returns True iff u is a product of integer powers of linears. "; *)
...
QuadraticProductQ::usage = "QuadraticProductQ[u,x] returns True iff u is a product of integer powers of linear or quadratic polynomials. ";
...
PowerOfLinearQ::usage = "PowerOfLinearQ[u,x] returns True iff u is equivalent to an expression of the form (a+b x)^m.";
...
PowerOfLinearMatchQ::usage = "PowerOfLinearMatchQ[u,x] returns True iff u matches patterns of the form (a+b x)^m where a, b and m are free of x.";
...
NormalizePowerOfLinear::usage = "u can be square-free factored into an expression of the form (a+b*x)^m.  NormalizePowerOfLinear[u,x] returns u in the form (a+b*x)^m.";
...
ExpandIntegrand::usage = "u is a polynomial in x.  ExpandIntegrand[u*(a+b*x)^m,x] expands u*(a+b*x)^m into a sum of terms of the form A*(a+b*x)^n.";
...
SmartApart::usage = "SmartApart[u,x] returns the partial fraction expansion of u wrt x, avoiding the strange behavior in the built-in Apart function that rationalizes denominators involving fractional powers resulting in hard to integrate expressions.";
...
Distrib::usage = "Distrib[u,v] returns the sum of u times each term of v.";
Distrib[u_,v_] :=
  If[SumQ[v],
    Map[Function[u*#],v],
  u*v]
...
Dist::usage = "Dist[u,v] returns the sum of u times each term of v, provided v is free of Int.";
DownValues[Dist]={};
UpValues[Dist]={};
...
DistributeDegree::usage = "DistributeDegree[u,m] returns the product of the factors of u each raised to the mth degree.";
